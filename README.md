...
| 화면 | 미리보기 |
|------|---------|
| 메인 화면 | ![메인화면](docs/화면/메인화면.png) |
| 로그인 | ![로그인](docs/화면/로그인.png) |
| 회원가입 | ![회원가입](docs/화면/회원가입.png) |
| 좌석 선택 (예매) | ![좌석선택](docs/화면/좌석선택(예매).png) |
| 마이페이지 (예매 내역) | ![마이페이지](docs/화면/마이페이지(예매내역조회).png) |
| 공연 관리 | ![공연관리](docs/화면/공연관리.png) |
| 공연 추가 | ![공연추가](docs/화면/공연추가.png) |
| 사용자 조회 및 권한 관리 | ![사용자관리](docs/화면/사용자조회%20및%20권한%20관리.png) |
